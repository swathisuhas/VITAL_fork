...
from utils.opt_inner_graph_in_activation import DeepFeaturesClass
...
def main():
    ...
    parser.add_argument('--channel', type=int, default=1305, help='channel id of the visualized neuron')

...
from utils.opt_inner_graph_with_crop import DeepFeaturesClass
...
def main():
    ...
    parser.add_argument('--channel', type=int, default=162, help='channel id of the visualized neuron')
